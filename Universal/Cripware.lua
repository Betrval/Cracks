...
local menu
do
    local library = loadstring(game:HttpGet("https://pastebin.com/raw/JtrX5Z6p"))()

    menu = library.new([[cripware <font color="rgb(255, 85, 89)">v1.a</font>]], "nemv2\\")
    local tabs = {
    ...
    do
        local aimbot = tabs[1].new_section("ragebot")
