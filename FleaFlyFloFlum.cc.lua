...
local Window = Library:New({Name = "fleaflyfloflum.cc", Accent = Color3.fromRGB(73, 82, 82)})
...
TargetBot_Main:Slider({Name = "Air Strafe Distance", Minimum = 1, Maximum = 40, Default = 10, Decimals = 0.1, Pointer = "Prediction", callback = function(boolean)_G.FRAME = Vector3.new(0,boolean,0)
end})
