                ...
                Plr.Character:WaitForChild("Humanoid").StateChanged:Connect(
                    function(old, new)
                        if new == Enum.HumanoidStateType.Freefall then
                            ...
                            getgenv().ZyZPart = "HumanoidRootPart"
                        end
                    end
                )
            end
...
local Window = Library:New({Name = "Bumblebee.cc", Accent = Color3.fromRGB(0, 0,255)})
local Aiming = Window:Page({Name = "Aiming"})
local Rage = Window:Page({Name = "Rage (WIP)"})
local Visuals = Window:Page({Name = "Visuals (WIP)"})

local TargetBot_Main = Aiming:Section({Name = "Target Aim", Side = "Left"})
...
TargetBot_Main:Toggle({Name = "ViewAt", Default = false, Pointer = "TargetBotMain_Enabled", callback = function(Bool)
...
TargetBot_Main:Toggle({Name = "Air Function", Default = false, Pointer = "TargetBotMain_Enabled", callback = function(bool)
    _G.AirshotFunction = bool
end})

TargetBot_Main:Toggle({Name = "Strafe", Default = false, Pointer = "TargetBotMain_Enabled", callback = function(book)
...
local Others_Main = Aiming:Section({Name = "May Not Work", Side = "Right"})
...
local Aiming = Window:Page({Name = "Extra"})